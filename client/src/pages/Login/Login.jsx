  ...
  return (
    <div className={classes.loginMainDiv} style={{
      ...
      <motion.div
        ...
        animate={{ x: 0, y: 0, opacity: 1, scale: 1 }} className={classes.loginBox}>
        ...
        <div style={{ marginBottom: "2rem" }} className={classes.selectoption}>
          <motion.div whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }} style={{ backgroundColor: `${selectedOption === "mentor" ? "#FFC23C" : "#A5C9CA"}` }} onClick={() => setSelectedOption("mentor")}><h1>Mentor</h1></motion.div>
          <motion.div whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }} style={{ backgroundColor: `${selectedOption === "mentee" ? "#FFC23C" : "#A5C9CA"}` }} onClick={() => setSelectedOption("mentee")}><h1>Mentee</h1></motion.div>
        </div>
        {
